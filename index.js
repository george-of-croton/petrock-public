...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    key: 'nameify',
	    value: function nameify(e) {
	      //gives your rock a name... in realtime!
	      this.setState({ name: e.target.value });
	      _fs2.default.writeFile('names.json', JSON.stringify(this.state), function () {
	    ...
	    value: function mount() {
	      _reactDom2.default.render(_react2.default.createElement(Profile, { unmount: this.unmount.bind(this), nameify: this.nameify.bind(this), name: this.state.name }), document.getElementById('a'));
	    }
	  }, {
	    key: 'unmount',
	    value: function unmount() {
	      console.log("unmounted");
	      _reactDom2.default.unmountComponentAtNode(document.getElementById('a'));
	    }
	  }, {
	    key: 'update',
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('div', { id: 'a' }),
	...
	var Footer = function (_React$Component2) {
	  ...
	  _createClass(Footer, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'a',
	        { href: 'https://github.com/george-of-croton' },
	        _react2.default.createElement(
	          'footer',
	          null,
	          'github'
	  ...
	  _createClass(Profile, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'text', onChange: this.props.nameify, placeholder: this.props.name }),
	        _react2.default.createElement(
	          'button',
